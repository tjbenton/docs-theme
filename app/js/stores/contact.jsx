let API = "http://addressbook-api.herokuapp.com/contacts",
    _contacts = {},
    _changeListeners = [],
    _initCalled = false;

let ContactStore = module.exports = {
 init: function(){
  if(_initCalled){
   return;
  }
...
function getJSON(url, cb){
 ...
 req.onload = function(){
  req.status === 404 ? cb(new Error("not found")) : cb(null, JSON.parse(req.response));
 };
 req.open("GET", url);
